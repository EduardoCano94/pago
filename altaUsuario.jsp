...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="AltaUsuarioSv" method="POST" autocomplete="off">
                <fieldset>
                    ...
                    <input type="password" id="password" name="password" placeholder="Mínimo 4 caracteres" minlength="4" required autocomplete="off">

                    <label for="password2">Repetir contraseña:</label>
                    <input type="password" id="password2" name="password2" placeholder="Repite tu contraseña" minlength="4" required autocomplete="off">
