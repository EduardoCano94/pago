...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <% } else { %>
            <form action="BuscarCiudadanoSv" method="POST" autocomplete="off">
                <fieldset>
                    <legend>Clave de Identificación del Ciudadano a Buscar:</legend>
                    <label for="claveIdentificacion">Clave de Identificación:</label>
                    <input type="text" id="claveIdentificacion" name="claveIdentificacion" placeholder="1234567890" required>
            ...
            <form action="BuscarCiudadanoSv" method="GET" autocomplete="off">
                <fieldset>
