    ...
    <body>
        ...
        <div class="container">
            ...
            <% Ciudadano ciudadano = (Ciudadano) miSesion.getAttribute("ciudadano");
                if (ciudadano == null) {
            %>
            <form action="BajaCiudadanoSv" method="POST" autocomplete="off">
                <fieldset>
                    ...
                    <input type="submit" value="Buscar Ciudadano a eliminar">
                </fieldset>
            </form>
            <%} else {%>
            <form action="BajaCiudadanoSv" method="GET" autocomplete="off">
                <fieldset>
